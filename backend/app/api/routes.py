...
@api.delete("/user/{user_id}/chats/{chat_id}")
...
async def send_chat_message(
    ...
    try:
        ...
        return StreamingResponse(
            chat_service.process_chat_message(db, user_id, chat_id, message, file_path),
...
async def create_new_chat(
    user_id: int, chat_data: schemas.ChatCreate, db: Session = Depends(get_db)
) -> Dict:
    try:
